            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="snippet.comment.label" default="Comment" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: snippetInstance, field: "comment")}</td>
